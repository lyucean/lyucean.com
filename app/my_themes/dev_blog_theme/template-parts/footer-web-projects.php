...
$footer_web_projects = [
    [
        ...
        'host' => 'abxtest.com',
        'desc' => 'ABX-тесты аудио: выдаёт пары треков, собирает ответы и шлёт итог в Telegram.',
    ],
    [
        'url'  => 'https://haccpro.ru',
        'host' => 'haccpro.ru',
        'desc' => 'SaaS по ХАССП: документы, онлайн-журналы, роли, клиентский кабинет и оплата.',
    ],
    [
    ...
    [
        ...
        'host' => 'logtail.ru',
        'desc' => 'Logtail - логи приложений в одном месте: приём, хранение, поиск и дашборды в реальном времени.',
    ],
];
?>
